      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            CircleAvatar(
              backgroundImage: CachedNetworkImageProvider(widget.status? widget.senderPic: widget.recieverPic),
            ),
      ...
      body: Column(
        children: [
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: const ShapeDecoration(
                                      color: Color.fromARGB(30, 111, 2, 44),
          ...
          Padding(
            ...
            child: Row(
              children: [
                const Icon(Icons.mic, color: Color.fromARGB(255, 111, 2, 43)),
                const SizedBox(width: 16.0),
                Expanded(
                  child: Row(
                    children: [
