...
class BOrderPending extends StatefulWidget {
  ...
  @override
  State<BOrderPending> createState() => _BOrderPendingState();
}

class _BOrderPendingState extends State<BOrderPending> {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return Scaffold(
        ...
        body: businessController.pendingOrders.isEmpty
            ? SizedBox(
            ...
            SingleChildScrollView(
                child: ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: businessController.pendingOrders.length,
                                      ...
                                      children: [
                                        SizedBox(
                                          width: MediaQuery.of(context)
                                              ...
                                              .4,
                                          child: Text(
                                            "Dish Name: ${businessController.pendingOrders[index]["name"]}",
                                            softWrap: true,
                                            maxLines: 2,
                                        ...
                                        Text(
                                            "Quantity: ${businessController.pendingOrders[index]['quantity'].toString()}"),
                                        Text(
                                          "Per Item Rs ${(int.parse(businessController.pendingOrders[index]["price"]) ~/ businessController.pendingOrders[index]["quantity"]).toStringAsFixed(2)}",
                                          softWrap: true,
                                          maxLines: 2,
                                        ),
                                        Text(
                                          "Total Rs ${businessController.pendingOrders[index]['price']}",
                                          style: const TextStyle(
                                              fontWeight: FontWeight.bold),
                                        ),
                                        const SizedBox(
