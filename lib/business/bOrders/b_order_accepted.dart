...
class BOrderAccepted extends StatefulWidget {
  final String userUid, userName, userEmail, status;
  const BOrderAccepted({
    super.key,
  ...
  @override
  State<BOrderAccepted> createState() => _BOrderAcceptedState();
}

class _BOrderAcceptedState extends State<BOrderAccepted> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<BusinessController>(builder: (businessController) {
      return Scaffold(
        ...
        body: businessController.acceptedOrders.isEmpty
            ? SizedBox(
            ...
            SingleChildScrollView(
                child: ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: businessController.acceptedOrders.length,
                                      ...
                                      children: [
                                        SizedBox(
                                          width: MediaQuery.of(context)
                                              ...
                                              .4,
                                          child: Text(
                                            "Dish Name: ${businessController.acceptedOrders[index]["name"]}",
                                            softWrap: true,
                                            maxLines: 2,
                                        ...
                                        Text(
                                            "Quantity: ${businessController.acceptedOrders[index]['quantity'].toString()}"),
                                        Text(
                                          "Per Item Rs ${(int.parse(businessController.acceptedOrders[index]["price"]) ~/ businessController.acceptedOrders[index]["quantity"]).toStringAsFixed(2)}",
                                          softWrap: true,
                                          maxLines: 2,
                                        ),
                                        Text(
                                          "Total Rs ${businessController.acceptedOrders[index]['price']}",
                                          style: const TextStyle(
                                              fontWeight: FontWeight.bold),
                                        ),
                                        const SizedBox(
